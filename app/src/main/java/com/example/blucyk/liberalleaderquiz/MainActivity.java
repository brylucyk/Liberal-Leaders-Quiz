...
public class MainActivity extends AppCompatActivity implements IQuestion  {
    ...
    public void checkAnswer(View v) {
        ...
        RadioButton radioButton = findViewById(R.id.justinTrudeauBtn);
    ...
    public void affectResult(boolean correctAnswer) {
        ...
        if(correctAnswer) {
            ...
            rightImg.setImageResource(R.drawable.circle_jt);
            rightImg.setContentDescription(getString(R.string.jt_imgDesc));
